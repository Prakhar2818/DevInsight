      ...
      >
        ...
        <div className="relative z-10 text-center px-12">
          ...
          <p className="text-lg text-slate-600 font-mono">
            Welcome back to your studio-grade code insights.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-slate-50">
        <div className="w-full max-w-md bg-white rounded-2xl p-10 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] border border-slate-100">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500 text-sm">Sign in to DevInsight AI</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="mt-8 w-full bg-slate-900 text-white rounded-xl py-3.5 font-semibold hover:bg-slate-800 transition-colors disabled:opacity-50"
            >
          ...
          <p className="mt-8 text-center text-sm text-slate-500">
            ...
            <Link href="/signup" className="font-semibold text-sky-500 hover:text-sky-600 transition-colors">
              Sign up now
            </Link>
          </p>
        </div>
